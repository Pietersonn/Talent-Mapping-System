...
<head>
    ...
    <style>
        ...
        table.data-table thead th { background: #e0e0e0; border: 1px solid #000; font-weight: bold; font-size: 11px; padding: 8px 5px; text-align: center; vertical-align: middle; }
        table.data-table tbody td { border: 1px solid #000; padding: 6px 5px; vertical-align: middle; text-align: center; }
...
<body>
    ...
    <div class="header clearfix">
        <div class="h-left">
            @if($logoBase64) <img class="h-logo" src="{{ $logoBase64 }}" alt="BCTI"> @else <strong>BCTI</strong> @endif
        </div>
        <div class="h-right">
    ...
    <div class="title-wrap">
        ...
        <div class="subtitle">{{ $modeText ?? 'Semua Peserta' }} • Dicetak oleh: {{ $generatedBy }} • {{ $generatedAt }}</div>
    </div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="14" style="padding:15px;">Tidak ada data.</td></tr>
            @endforelse
        </tbody>
    </table>
